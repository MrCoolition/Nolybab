...
const responseSchema = {
  ...
  properties: {
    ...
    doctrineOrBlueprint: { type: 'string', minLength: 12, maxLength: 220 },
    worldLine: { type: 'string', minLength: 10, maxLength: 170 },
    costNarrative: { type: 'string', minLength: 8, maxLength: 130 },
    consequence: { type: 'string', minLength: 12, maxLength: 180 },
    dissent: { type: 'string', minLength: 8, maxLength: 150 },
    humanThread: {
      type: 'object',
      additionalProperties: false,
      ...
      properties: {
        ...
        originMemory: { type: 'string', minLength: 12, maxLength: 160 },
        skills: {
          type: 'array',
          minItems: 3,
          maxItems: 3,
        ...
        needs: {
          ...
          minItems: 2,
          maxItems: 2,
          items: { type: 'string', minLength: 2, maxLength: 44 },
        },
        vow: { type: 'string', minLength: 8, maxLength: 120 },
      },
    },
    visualDirection: {
      type: 'object',
      ...
      properties: {
        ...
        material: { type: 'string', minLength: 3, maxLength: 48 },
        motif: { type: 'string', enum: MOTIFS },
        motion: { type: 'string', enum: MOTIONS },
        weather: { type: 'string', minLength: 3, maxLength: 60 },
        landmark: { type: 'string', minLength: 4, maxLength: 90 },
      },
    },
    gamemasters: {
      type: 'object',
      ...
      properties: {
        illustrator: { type: 'string', minLength: 8, maxLength: 150 },
        ecologist: { type: 'string', minLength: 8, maxLength: 150 },
        anthropologist: { type: 'string', minLength: 8, maxLength: 150 },
        inventor: { type: 'string', minLength: 8, maxLength: 150 },
      },
    },
    options: {
      type: 'array',
      ...
      items: {
        ...
        properties: {
          ...
          promise: { type: 'string', minLength: 10, maxLength: 140 },
          risk: { type: 'string', minLength: 8, maxLength: 120 },
          visualHook: { type: 'string', minLength: 5, maxLength: 100 },
        },
      },
    },
  },
